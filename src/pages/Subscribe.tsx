...
export function Subscribe(){
    ...
    return(
        <div className="min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center">
            <div className="w-full max-w-[1100px] flex items-center justify-between mx-auto mt-20">
                ...
                <div className="p-8 bg-gray-700 border border-gray-500 rounded">
                    ...
                    <form onSubmit={handleSubscribe} className="flex flex-col gap-2 w-full">
                        ...
                        <button 
                            type="submit"
                            disabled={loading}
                            className="mt-2 bg-green-500 uppercase py-4 rounded font-bold text-sm hover:bg-green-700 transition-colors disabled:opacity-50"
                        >
                            Garantir minha vaga
                        </button>
                    </form>
